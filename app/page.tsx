...
export default function Page() {
  ...
  return <main>
    ...
    <section className="hero wrap" id="top"><div className="hero-label"><span className="status-dot" />AVAILABLE FOR SELECTED WORK</div><div className="hero-grid"><div className="hero-copy"><h1>把想法<br /><span>做成真的。</span></h1><p className="hero-intro">我是洪睦荃，住在台北的<br /><strong>Frontend Engineer</strong>。<br />專注在把複雜的事，做得清楚又好用。</p><a href="#work" className="hero-cta">看看我的作品 <ArrowUpRight /></a></div><div className="hero-art" aria-label="Layered interface paths illustration" role="img"><div className="art-grid" /><div className="art-path art-path-one"><span /><span /><span /></div><div className="art-path art-path-two"><span /><span /><span /></div><div className="art-panel art-panel-back"><span className="art-panel-label">SYSTEM / 01</span><strong>clear<br />by design</strong></div><div className="art-panel art-panel-front"><span className="art-panel-label">MCH / BUILDING</span><div className="art-bars"><i /><i /><i /></div><div className="art-panel-footer"><span>product thinking</span><span>↗</span></div></div><div className="art-node art-node-top" /><div className="art-node art-node-bottom" /></div></div></section>
